...
QUnit.test('assertions', function(assert) {
    ...
    assert.equal( "str", "str", 'один эквивалентно одному');
...
QUnit.test('test', function(assert) {
    assert.deepEqual( 5, 5, 'один эквивалентно одному');
